...
class ScrapeDataGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ScrapeData entity")
        ...
        .repeat(2) {
            ...
            .get("/crawlerconfiguration/api/scrape-data")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new scrapeData")
            .post("/crawlerconfiguration/api/scrape-data")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/crawlerconfiguration${new_scrapeData_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created scrapeData")
            .delete("/crawlerconfiguration${new_scrapeData_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
