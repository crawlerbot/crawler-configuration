...
class HistoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the History entity")
        ...
        .repeat(2) {
            ...
            .get("/crawlerconfiguration/api/histories")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new history")
            .post("/crawlerconfiguration/api/histories")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/crawlerconfiguration${new_history_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created history")
            .delete("/crawlerconfiguration${new_history_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
