...
class SiteChannelGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SiteChannel entity")
        ...
        .repeat(2) {
            ...
            .get("/crawlerconfiguration/api/site-channels")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new siteChannel")
            .post("/crawlerconfiguration/api/site-channels")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/crawlerconfiguration${new_siteChannel_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created siteChannel")
            .delete("/crawlerconfiguration${new_siteChannel_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
